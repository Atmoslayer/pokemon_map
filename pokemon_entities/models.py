...
class Pokemon(models.Model):
    title = models.CharField(default='Покемон', max_length=20, verbose_name='Имя на русском')
    title_en = models.CharField(default='Pokemon', max_length=20, verbose_name='Имя на английском')
    title_jp = models.CharField(default='ポケモン', max_length=20, verbose_name='Имя на японском')
